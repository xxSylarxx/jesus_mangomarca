    ...
    <section class="container lista">
        ...
        <div class="row justify-content-between mt-4">
            ...
            <div class="col-md-4 my-2 ">
                <!-- <div class="card" id="sidebar" style="border-bottom: 2px solid var(--color3);">
                    <div class="card-body">
                        <h5 class="fw-bold mb-2" style="color:var(--color1);">Categoríass</h5>
                        <div class="d-flex" style="font-size: 14.5px;">
                            <a href="./doc-matricula.php">Documentos Matrícula</a>
                        </div>
                        <div class="d-flex" style="font-size: 14.5px;">
                            <a href="./doc-gestion.php">Documentos de Gestión</a>
                        </div>
                        <h5 class="fw-bold mb-2 mt-4" style="color:var(--color1);">Publicaciones Recientes</h5>
                        <ul class="list-group list-group-flush">
                        </ul>
                    </div>
                </div> -->
                <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fprofile.php%3Fid%3D100040278324313&tabs=timeline&width=340&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=928526382184489" width="100%" height="650" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
            </div>
